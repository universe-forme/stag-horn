...
const SwordsItems = () => {
    const { data: products, isLoading, error } = useProductsByCategorySlug('swords', 5);

    if (isLoading) {
        return (
            <div className="p-6 lg:p-12">
                <div className="container mx-auto">
                    <h2 className="cabin-font text-4xl font-normal text-black text-center mb-12">Swords</h2>
    ...
    if (!products || products.length === 0) {
        return (
            <div className="p-6 lg:p-12">
                <div className="container mx-auto">
                    <h2 className="cabin-font text-4xl font-normal text-black text-center mb-12">Swords</h2>
                    <div className="text-center text-gray-500">No sword products available at the moment.</div>
                </div>
            </div>
        );
    }
        ...
        <div className="p-6 lg:p-12">
            <div className="container mx-auto">
                ...
                <div className="text-center">
                    <Link href="/product?category=swords">
